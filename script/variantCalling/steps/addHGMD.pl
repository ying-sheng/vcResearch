...
foreach my $eachAnn (@annotationFiles){
  ...
  $tagExpression = "-E $resourceTag.amino -E $resourceTag.acc_num -E $resourceTag.disease -E $resourceTag.amimid -E $resourceTag.tag -E $resourceTag.comments -E $resourceTag.pmid -E $resourceTag.location -E $resourceTag.locref -E $resourceTag.deletion -E $resourceTag.insertion -E $resourceTag.type -E $resourceTag.score -E $resourceTag.wildtype ";
